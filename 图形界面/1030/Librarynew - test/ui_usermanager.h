...
public:
    ...
    void setupUi(QWidget *UserManager)
    {
        ...
        le_school->setGeometry(QRect(290, 50, 121, 41));
        ...
        le_major->setGeometry(QRect(410, 50, 111, 41));
        ...
        le_email->setGeometry(QRect(520, 50, 121, 41));
        le_email->setFont(font1);
        le_email->setClearButtonEnabled(false);
        le_password = new QLineEdit(groupBox_2);
        le_password->setObjectName(QStringLiteral("le_password"));
        le_password->setGeometry(QRect(180, 50, 111, 41));
        le_password->setFont(font1);
        le_password->setClearButtonEnabled(false);
    ...
    void retranslateUi(QWidget *UserManager)
    {
        ...
        le_password->setPlaceholderText(QApplication::translate("UserManager", "\345\257\206\347\240\201", Q_NULLPTR));
        ...
        ___qtablewidgetitem2->setText(QApplication::translate("UserManager", "\345\257\206\347\240\201", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = infotable->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("UserManager", "\345\255\246\346\240\241", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = infotable->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("UserManager", "\344\270\223\344\270\232", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem5 = infotable->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("UserManager", "\351\202\256\347\256\261", Q_NULLPTR));
