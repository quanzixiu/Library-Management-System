...
QT_MOC_LITERAL(5, 81, 18), // "on_addsure_clicked"
QT_MOC_LITERAL(6, 100, 19), // "on_addbooks_clicked"
QT_MOC_LITERAL(7, 120, 22), // "on_updatebooks_clicked"
QT_MOC_LITERAL(8, 143, 22) // "on_deletebooks_clicked"

    },
    "BookManager\0on_gotomainpage_clicked\0"
    "\0on_exitlogin_clicked\0on_confirmsure_clicked\0"
    "on_addsure_clicked\0on_addbooks_clicked\0"
    "on_updatebooks_clicked\0on_deletebooks_clicked"
};
...
void BookManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->on_addbooks_clicked(); break;
        case 5: _t->on_updatebooks_clicked(); break;
        case 6: _t->on_deletebooks_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
