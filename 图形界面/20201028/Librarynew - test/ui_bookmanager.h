...
public:
    ...
    void setupUi(QWidget *BookManager)
    {
        ...
        le_writer->setGeometry(QRect(180, 50, 161, 41));
        ...
        le_bookname->setGeometry(QRect(340, 50, 111, 41));
        ...
        addsure = new QPushButton(groupBox_2);
    ...
    void retranslateUi(QWidget *BookManager)
    {
        ...
        addsure->setText(QApplication::translate("BookManager", "\346\267\273\345\212\240", Q_NULLPTR));
        ...
        ___qtablewidgetitem2->setText(QApplication::translate("BookManager", "\344\275\234\350\200\205", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = infotable->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("BookManager", "\344\271\246\345\220\215", Q_NULLPTR));
