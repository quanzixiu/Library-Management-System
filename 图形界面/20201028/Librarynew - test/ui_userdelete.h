...
public:
    ...
    void setupUi(QWidget *UserDelete)
    {
        ...
        deletesure = new QPushButton(groupBox);
        deletesure->setObjectName(QStringLiteral("deletesure"));
        deletesure->setGeometry(QRect(710, 380, 75, 23));
        borrowinfotable = new QTableWidget(groupBox);
        borrowinfotable->setObjectName(QStringLiteral("borrowinfotable"));
        borrowinfotable->setGeometry(QRect(40, 170, 771, 241));
        borrowinfotable->raise();
        groupBox_2->raise();
        deletesure->raise();
        exitlogin1 = new QPushButton(UserDelete);
        exitlogin1->setObjectName(QStringLiteral("exitlogin1"));
        exitlogin1->setGeometry(QRect(1050, 620, 131, 51));
    ...
    void retranslateUi(QWidget *UserDelete)
    {
        ...
        deletesure->setText(QApplication::translate("UserDelete", "\345\210\240\351\231\244", Q_NULLPTR));
        exitlogin1->setText(QApplication::translate("UserDelete", "\351\200\200\345\207\272\347\231\273\345\275\225", Q_NULLPTR));
    } // retranslateUi
