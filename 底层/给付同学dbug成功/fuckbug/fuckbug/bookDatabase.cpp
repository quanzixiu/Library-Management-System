...
{
	scale = 5;
	indexFile.open("bookindex.txt", ios::in | ios::out | ios::binary);
	dataFile.open("bookdata.txt", ios::in | ios::out | ios::binary);
	logFile.open("booklog.txt", ios::trunc);
	if (!indexFile)
	{
		indexFile.close();
		dataFile.close();
		ofstream index("bookindex.txt", ios::binary);
		ofstream data("bookdata.txt", ios::binary);
		int firstEmpty = 8;
...
void bookDatabase::dataFile_find(const int dataAddress, string &value)
{
	char tmp[80];
	dataFile.clear();
...
int bookDatabase::dataFile_add(const string &value)
{
...
void bookDatabase::dataFile_delete(const int dataAddress)
{
	int next;
	dataFile.seekg(0);
	dataFile.read(reinterpret_cast<char *>(&next), sizeof(int));
...
void bookDatabase::dataFile_replace(const int dataAddress, string &value)
{
	dataFile.seekp(dataAddress);
	dataFile.write(value.c_str(), value.size() + 1);
}

int bookDatabase::indexFile_find(int key, int *indexAddress, int *pos, int *size, int *dataAddress)
{
	int current, next = 0;
...
void bookDatabase::indexFile_add(const int key, const int dataAddress, const int indexAddress, int pos, int size)
{
...
void bookDatabase::indexFile_addAndOverflow(const int key, const int dataAddress, const int indexAddress, const int pos, const int size)
{
...
bool bookDatabase::indexFile_delete(const int indexAddress, const int pos, int size)
{
...
void bookDatabase::indexFile_borrowLeft(const int indexAddress, int size, const int left, int leftSize, int parent, int parentPosition)
{
...
void bookDatabase::indexFile_borrowRight(const int indexAddress, int size, const int right, int rightSize, int parent, int parentPosition)
{
...
void bookDatabase::indexFile_mergeLeft(const int indexAddress, const int size, const int left, int leftSize)
{
...
void bookDatabase::indexFile_mergeRight(const int indexAddress, int size, const int right, const int rightSize)
{
...
void bookDatabase::indexFile_deleteAndUnderflow(const int indexAddress, const int pos, int size)
{
...
bool bookDatabase::file_update(const int key, string &value)
{
...
bool bookDatabase::select(const int key, string & value)
{
...
bool bookDatabase::insert(const int key, const string &value)
{
...
bool bookDatabase::remove(const int key)
{
...
bool bookDatabase::update(const int key, string &value)
{
